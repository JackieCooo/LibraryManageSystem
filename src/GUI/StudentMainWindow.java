...
public class StudentMainWindow {
    ...
    JButton minimiseBtn;
    JButton closeBtn;
    JTabbedPane centrePanel;
    JPanel userMainWindow;
    JPanel topPanel;
    JButton bookRepoBtn;
    JButton myCollectBtn;
    JButton myBorrowBtn;
    JButton mySpaceBtn;
    JPanel bottomPanel;
    ...
    JPanel accountPanel;
    JLabel userPic;
    JScrollPane recommendPage;
    JScrollPane bookChartPage;
    JScrollPane latestBookPage;
    JPanel recommendPanel;
    JPanel bookChartPanel;
    JPanel latestBookPanel;
